"""
  Notification Mnode Node

  TODO:
    - Make sure Mnode name is get_valid_node_name, and Length
...
class Mnode(polyinterface.Node):
    """
    """
    def __init__(self, controller, primary, address, name, info):
        ...
        super(Mnode, self).__init__(controller, primary, address, name)
    ...
    def setDriver(self,driver,value):
        ...
        super(Mnode, self).setDriver(driver,value)

    def getDriver(self,driver):
        if driver in self.driver:
            return self.driver[driver]
        else:
            return super(Mnode, self).getDriver(driver)
    ...
    def do_send(self,params):
        ...
        priority=self.get_Mnode_priority()
        callback=None
        retry=30
        expire=86400
        sound=None
